...
export async function createExchangeRequest({
  ...
  try {
    ...
    console.error("Помилка при створенні запиту на обмін:", error);
    throw error;
  }
}
...
export async function getIncomingRequests(
  ...
  try {
    ...
    console.error("Помилка при отриманні вхідних запитів:", error);
    throw error;
  }
}
...
export async function getOutgoingRequests(
  ...
  try {
    ...
    console.error("Помилка при отриманні вихідних запитів:", error);
    throw error;
  }
}
...
export async function updateRequestStatus(
  ...
  try {
    ...
    console.error("Помилка при оновленні статусу запиту:", error);
    throw error;
  }
}
